...
import com.example.slimguy.projectkinda.Models.viewcom;
...
public class viewcomplaint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Complaints Response");
    ...
    private class Background extends AsyncTask<String, String, String> {
        ...
        protected class GetConnected {
            ...
            String sign_url = "http://" + constant + "/" + folder + "/viewcomplain.php";
        ...
        private class ParserData extends AsyncTask<String, Void, Boolean> {
            ...
            ListView listView;
            String jsondata;
            ArrayList<viewcom> arrayList = new ArrayList<>();
            ...
            private Boolean ParseJsonDt() {
                ...
                try {
                    ...
                    while (i < jsonArray.length()) {
                        ...
                        model = new viewcom();
                        model.setKidnumberc(jsonObject.getString("kidnumber"));
                        model.setTowho(jsonObject.getString("towho"));
                        model.setAboutc(jsonObject.getString("about"));
                        model.setLevelc(jsonObject.getString("leve"));
                        model.setComplain(jsonObject.getString("complain"));

                        model.setCompdate(jsonObject.getString("comp_date"));
        ...
        private class AdapterClass extends BaseAdapter {
            ...
            ArrayList<viewcom> models;
            Context context;
            ListView listView;

            public AdapterClass(ArrayList<viewcom> spacecraftArrayList, Context context, ListView listView) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (viewHolder == null) {
                    convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.compview, null);
                ...
                viewcom model = models.get(position);
                String kidnumber,towho, about, leve, complain, comp_date;
                kidnumber = model.getKidnumberc();
                towho = model.getTowho();
                about = model.getAboutc();
                leve = model.getLevelc();
                complain = model.getComplain();

                comp_date = model.getCompdate();
                viewHolder.kidnumber.setText(kidnumber);
                viewHolder.towho.setText(towho);
                viewHolder.about.setText(about);
                viewHolder.leve.setText(leve);
                viewHolder.complain.setText(complain);

                viewHolder.comp_date.setText(comp_date);
                return convertView;
            }


            public class ViewHolder {
                TextView kidnumber,towho, about, leve, complain, comp_date;
                View view;

                public ViewHolder(View view) {
                    this.view = view;
                    kidnumber = view.findViewById(R.id.kidnumber);
                    towho = view.findViewById(R.id.towho);
                    about = view.findViewById(R.id.about);
                    leve = view.findViewById(R.id.leve);
                    complain = view.findViewById(R.id.complain);

                    comp_date= view.findViewById(R.id.comp_date);
                }
            }
        }
    }

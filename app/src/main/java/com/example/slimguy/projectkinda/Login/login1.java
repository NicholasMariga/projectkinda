...
public class login1 extends AppCompatActivity {
    ...
    public void parentlogclicked(View v) {
        ...
        clas = level.getSelectedItem().toString();
        ;
    ...
    public void forgotpassword(View v){
        Toast.makeText(login1.this, "Consult the School Director. Thank you", Toast.LENGTH_SHORT).show();
    }
}
// String password = "";

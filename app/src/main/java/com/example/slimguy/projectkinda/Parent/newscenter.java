...
public class newscenter extends AppCompatActivity {
    ...
    private class Background extends AsyncTask<String, String, String> {
        ...
        protected class GetConnected {
            ...
            String sign_url = "http://" + constant + "/" + folder + "/news.php";
        ...
        private class ParserData extends AsyncTask<String, Void, Boolean> {
            ...
            ListView listView;
            String jsondata;
            ArrayList<newss> arrayList = new ArrayList<>();
            ...
            private Boolean ParseJsonDt() {
                ...
                try {
                    ...
                    while (i < jsonArray.length()) {
                        ...
                        model = new newss();
                        model.setnewdate(jsonObject.getString("newdate"));
...
//                        }
        ...
        private class AdapterClass extends BaseAdapter {
            ...
            ArrayList<newss> models;
            Context context;
            ListView listView;

            public AdapterClass(ArrayList<newss> spacecraftArrayList, Context context, ListView listView) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (viewHolder == null) {
                    convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.newsce, null);
                ...
                newss model = models.get(position);
                String newdate, news;
                newdate = model.getnewdate();
                news = model.getnews();


                viewHolder.newdate.setText(newdate);
                viewHolder.news.setText(news);

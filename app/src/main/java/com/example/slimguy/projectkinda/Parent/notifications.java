...
import com.example.slimguy.projectkinda.Notifications.notic;
...
public class notifications extends AppCompatActivity {
    ...
    private class Background extends AsyncTask<String, String, String> {
        ...
        protected class GetConnected {
            ...
            String sign_url = "http://" + constant + "/" + folder + "/notifications.php";
        ...
        private class ParserData extends AsyncTask<String, Void, Boolean> {
            ...
            ListView listView;
            String jsondata;
            ArrayList<notic> arrayList = new ArrayList<>();
            ...
            private Boolean ParseJsonDt() {
                ...
                try {
                    ...
                    while (i < jsonArray.length()) {
                        ...
                        model = new notic();
                        model.setLevel1(jsonObject.getString("level"));
                        model.setNotices(jsonObject.getString("notices"));
                        model.setNoticedate(jsonObject.getString("noticedate"));
        ...
        private class AdapterClass extends BaseAdapter {
            ...
            ArrayList<notic> models;
            Context context;
            ListView listView;

            public AdapterClass(ArrayList<notic> spacecraftArrayList, Context context, ListView listView) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (viewHolder == null) {
                    convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.noti, null);
                ...
                notic model = models.get(position);
                String level, notices, noticedate;
                level = model.getLevel1();
                notices = model.getNotices();
                noticedate = model.getNoticedate();

                viewHolder.level.setText(level);
                viewHolder.notices.setText(notices);
                viewHolder.noticedate.setText(noticedate);
            ...
            public class ViewHolder {
                TextView level, notices, noticedate;
                View view;

...
import com.example.slimguy.projectkinda.News.news;
import com.example.slimguy.projectkinda.Frags.noticefrag;
import com.example.slimguy.projectkinda.Notifications.notifications;
...
public class parent extends AppCompatActivity
    ...
    public void newsclick(View v){
        Intent logg = new Intent(parent.this, news.class);
        startActivity(logg);
    }

...
public class behaviourParent extends AppCompatActivity {
    ListView listView;
    String constant;
    String folder;
    ...
    private class Background extends AsyncTask<String, String, String> {
        ...
        protected class GetConnected {
            ...
            String sign_url = "http://" + constant + "/" + folder + "/behaviour.php";
        ...
        private class AdapterClass extends BaseAdapter {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (viewHolder == null) {
                    convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.behavior, null);
                ...
                String level,kidname,parentname,behavior,behavie,date;
            ...
            public class ViewHolder {
                ...
                TextView level,kidname,parentname,behavior,behavie,date;
                View view;
